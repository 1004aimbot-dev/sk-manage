...
export default async function Page() {
  const departmentId = "young-adult";
  ...
  if (res.success && res.data?.roleInfo) {
    try {
      ...
      console.error("Failed to parse roleInfo for young-adult", e);
    }
  }

  return <MinistryManagement title="청년부" initialData={initialData} departmentId={departmentId} />;
}
